...
<!-- Mirrored from preview.colorlib.com/theme/sportsteam/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Apr 2023 10:03:39 GMT -->
...
<head>
    ...
    <script nonce="65f39a35-1330-4f7e-9331-cce4f4b884cb">
        (function(w, d) {
...
<body>
                            ...
                            <div class="result text-right">
                                <div class="result_content d-flex flex-row align-items-end justify-content-start">
                                    <div class="team_image d-flex flex-column align-items-start justify-content-end">
                                        <img src="images/result_1.jpg" alt=""></div>
                                ...
                                <li class="d-flex flex-row align-items-center justify-content-start">
                                    <div class="d-flex flex-row align-items-center justify-content-start">
                                        <div
                                            ...
                                            <img src="images/logo_1.png" alt=""></div>
                                    ...
                                    <div class="d-flex flex-row align-items-center justify-content-end">
                                        ...
                                        <div
                                            class="team_logo d-flex flex-column align-items-center justify-content-center">
                                            <img src="images/logo_2.png" alt=""></div>
                                    </div>
                                </li>
                                <li class="d-flex flex-row align-items-center justify-content-start">
                                    <div class="d-flex flex-row align-items-center justify-content-start">
                                    ...
                                    <div class="d-flex flex-row align-items-center justify-content-end">
                                        ...
                                        <div
                                            class="team_logo d-flex flex-column align-items-center justify-content-center">
                                            <img src="images/logo_4.png" alt=""></div>
                                    </div>
                                </li>
                                <li class="d-flex flex-row align-items-center justify-content-start">
                                    <div class="d-flex flex-row align-items-center justify-content-start">
                                    ...
                                    <ul>
                                        ...
                                        <li class="d-flex flex-row align-items-start justify-content-start">
                                            ...
                                            <div><a href="https://preview.colorlib.com/cdn-cgi/l/email-protection"
                                                    class="__cf_email__"
                                                    data-cfemail="2a53455f58474b43466a4d474b434604494547">[email&#160;protected]</a>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
    ...
    <script defer src="https://static.cloudflareinsights.com/beacon.min.js/v2b4487d741ca48dcbadcaf954e159fc61680799950996"
        ...
        data-cf-beacon='{"rayId":"7b4170092ce0020a","version":"2023.3.0","b":1,"token":"cd0b4b3a733644fc843ef0b185f98241","si":100}'
